            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-0 bg-muted/30">
                  ...
                  <th rowSpan={2} className="hidden xl:table-cell text-left px-3 py-2.5 font-medium text-muted-foreground text-xs align-middle border-b border-muted">Resolução</th>
                  ...
                  <th rowSpan={2} className="hidden xl:table-cell text-left px-3 py-2.5 font-medium text-muted-foreground text-xs align-middle border-b border-muted">Cadastrado em</th>
                  ...
                  <th rowSpan={2} className="hidden xl:table-cell text-left px-3 py-2.5 font-medium text-muted-foreground text-xs align-middle border-b border-muted">Último Sinal</th>
                  <th rowSpan={2} className="hidden xl:table-cell text-left px-3 py-2.5 font-medium text-muted-foreground text-xs align-middle border-b border-muted">Localização</th>
                  ...
                  <th rowSpan={2} className="hidden xl:table-cell text-left px-3 py-2.5 font-medium text-muted-foreground text-xs align-middle border-b border-muted">Tags</th>
              ...
              <tbody>
                ...
                {onlineScreens.length > 0 && (
                  <tr>
                    <td colSpan={99} className="px-4 py-2 bg-emerald-500/8 border-b border-emerald-500/20">
                ...
                {offlineScreens.length > 0 && (
                  <tr>
                    <td colSpan={99} className="px-4 py-2 bg-muted/20 border-b border-muted/40">
