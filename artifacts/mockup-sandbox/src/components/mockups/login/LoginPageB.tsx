      ...
      <div>
        <div className="mb-12 flex items-center gap-2.5">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-lg font-extrabold tracking-tight text-white">RPShow</span>
...
const OVERLAY = "linear-gradient(135deg, rgba(10,20,60,0.85) 0%, rgba(15,32,68,0.65) 60%, rgba(121,180,176,0.25) 100%)";
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden font-sans">
      ...
      <div className="relative flex-1 overflow-hidden">
        <img src="/__mockup/login-bg-laptop.png" alt="" className="absolute inset-0 h-full w-full object-cover" />
